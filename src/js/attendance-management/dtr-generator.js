...
function buildDTRData(employeeLogs, startDay, endDay, month, year) {
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    if (dayLogs.length > 0) {
      ...
      const departure = timeOuts.length > 0 ? timeOuts[timeOuts.length - 1] : '';
          ...
          <div>
            ...
            <table class="dtr-table">
              ...
              <tbody>
                ...
                `).join('')}
                ${leftColumn.length < 31 ? Array(31 - leftColumn.length).fill(0).map((_, i) => `
                  <tr>
                    <td style="font-weight: bold;">${leftColumn.length + i + 1}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
          ...
          <div>
            ...
            <table class="dtr-table">
              ...
              <tbody>
                ...
                `).join('')}
                ${rightColumn.length < 31 ? Array(31 - rightColumn.length).fill(0).map((_, i) => `
                  <tr>
                    <td style="font-weight: bold;">${rightColumn.length + i + 1}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
